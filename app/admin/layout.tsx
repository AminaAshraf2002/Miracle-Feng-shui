  ...
  if (isAuthenticated === null || !isAuthenticated) {
    return (
      <div className="min-h-screen bg-[#140D1F] flex flex-col items-center justify-center text-white font-outfit">
        <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-yellow-400/40 mb-3 animate-pulse shadow-md">
          <img
        ...
        <p className="text-xs font-medium text-yellow-200/90 tracking-wide">
    ...
    <div className="min-h-screen bg-[#F7F6F3] text-[#140D1F] flex flex-col lg:flex-row font-outfit antialiased">
      ...
      <div className="lg:hidden bg-[#140D1F] text-white px-4 py-2.5 flex items-center justify-between border-b border-white/10 sticky top-0 z-40 shadow-xs">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full overflow-hidden border border-yellow-400/40 bg-white shrink-0">
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-7 w-6 h-6 rounded-full bg-white text-[#140D1F] shadow-md border border-gray-200 flex items-center justify-center text-[10px] cursor-pointer hover:bg-yellow-50 hover:text-yellow-700 hover:scale-105 transition-all z-50"
        >
          <i
            className={`fa-solid ${
        ...
        <div>
          ...
          >
            <div className="w-9 h-9 rounded-xl overflow-hidden border-2 border-yellow-400/40 shadow-sm shrink-0 bg-white">
              <img
                src="/images/miracle.jpeg"
                alt="Miracle Feng Shui"
                className="w-full h-full object-cover"
            ...
            {!sidebarCollapsed && (
              <div className="min-w-0 transition-opacity duration-200">
                ...
                <span className="text-[9px] text-yellow-300 font-semibold tracking-wider uppercase block">
                  COMMAND CENTER
                </span>
              </div>
            )}
        ...
        <div className="pt-4 border-t border-white/10 flex flex-col gap-2.5">
          {!sidebarCollapsed && (
            <div className="bg-white/5 rounded-xl p-3 border border-white/10 text-center">
              <div className="w-6 h-6 rounded-full bg-yellow-400/20 text-yellow-300 flex items-center justify-center mx-auto mb-1 text-[10px]">
          ...
          <div className="w-64 bg-gradient-to-b from-[#140D1F] via-[#1A1028] to-[#120A1A] text-white h-full p-5 flex flex-col justify-between shadow-2xl animate-in slide-in-from-left duration-200">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-white/10">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-xl overflow-hidden border border-yellow-400/40 bg-white">
                    <img src="/images/miracle.jpeg" alt="Miracle" className="w-full h-full object-cover" />
                  </div>
