...
export default function AdminHomepageManager() {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Toast */}
      {saveToast && (
        <div className="fixed bottom-6 right-6 z-50 bg-[#1E132A] text-white px-5 py-3 rounded-xl shadow-xl flex items-center gap-3 border border-amber-400/30 animate-bounce">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 sm:p-6 rounded-2xl border border-gray-100 shadow-2xs">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Link
            href="/"
            target="_blank"
            className="bg-[#2A1D38] hover:bg-[#1E132A] text-white text-xs sm:text-sm font-semibold px-4 py-2 rounded-xl transition-all shadow-sm no-underline inline-flex items-center gap-2"
          >
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-gray-100">
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl text-xs font-semibold bg-[#2A1D38] hover:bg-[#1E132A] text-white shadow-xs transition-all cursor-pointer inline-flex items-center gap-1.5"
                >
